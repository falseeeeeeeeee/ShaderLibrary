...
[VolumeComponentMenu(CustomVolumeDefine.ColorAdjustment + "色相亮度饱和度对比度 (HueBrightnessSaturationContrast)")]
public class HueBrightnessSaturationContrast : CustomVolumeComponent
{
    //颜色调整属性
