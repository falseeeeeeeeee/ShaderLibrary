Shader "URP/Render/S_TownscaperWindowAll"
{
    Properties
    {
        [Header(Base)] [Space(6)]
...
//        _NightSwitch ("Night Switch", Range(0.0, 1.0)) = 0.0
...
//        [Enum(UnityEngine.Rendering.CompareFunction)] _ZTestMode ("ZTestMode", Float) = 4
        ...
        [Enum(UnityEngine.Rendering.StencilOp)]_StencilPass ("Stencil Pass", Float) = 5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _USEHARDLAMBERT_ON
