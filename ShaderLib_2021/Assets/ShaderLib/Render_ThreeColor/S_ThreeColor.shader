Shader "URP/Render/S_ThreeColor"
{
    Properties 
    {
        ...
        _DownColor  ("Down Color",  Color) = (0, 0, 0, 1)
        _FrontColor ("Front Color", Color) = (0, 1, 0, 1)
        _BackColor  ("Back Color",  Color) = (0, 0, 0, 1)        
        _LeftColor  ("Left Color",  Color) = (0, 0, 1, 1)
        _RightColor ("Right Color", Color) = (0, 0, 0, 1)

        [Toggle] _EnableWSColor ("Enable WorldSpace Color", Float) = 0.0
        [Toggle] _EnableColorShadow ("Enable ColorShadow", Float) = 0.0
    ...
    SubShader 
    {
        ...
        Pass {
            ...
            #pragma shader_feature _ENABLEWSCOLOR_ON
