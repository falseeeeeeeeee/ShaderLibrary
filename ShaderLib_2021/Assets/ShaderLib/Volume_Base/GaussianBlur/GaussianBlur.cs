...
public class GaussianBlur : CustomVolumeComponent
{
    ...
    //模糊
    public ClampedIntParameter iterations  = new ClampedIntParameter(0, 0, 8);                   //迭代次数
    public ClampedFloatParameter blurSpread  = new ClampedFloatParameter(0.6f, 0.2f, 3.0f);      //模糊大小
